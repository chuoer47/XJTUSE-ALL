...
public class BST<K extends Comparable<K>, V> {
    ...
    public String[] formName() {
        String[] name = new String[numNode];
        formName(name, root);
        return name;
    }
    public void formName(String[] name, Node rt) {
        if (rt == null) {
            return;
        } else {
            formName(name, rt.left);
            name[++namePivot] = (String) rt.key;
            formName(name, rt.right);
        }
    }
