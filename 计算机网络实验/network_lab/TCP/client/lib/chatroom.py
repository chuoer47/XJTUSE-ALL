...
class Ui_SafeChatroom(object):
    ...
    def retranslateUi(self, SafeChatroom):
        ...
        SafeChatroom.setWindowTitle(_translate("SafeChatroom", "TCP"))
        self.send.setText(_translate("SafeChatroom", "注册"))
        self.historySaver.setText(_translate("SafeChatroom", "登录"))
