...
- `day1-10/` —— day1~day10 的 Java 代码（工厂、单例、建造者、原型、适配器、桥接、过滤器、组合、装饰器、外观）
- `day11-20/` —— day11~day19 的 Java 代码（享元、代理、责任链、命令、解释器、迭代器、中介者、备忘录、观察者）
  - 每个 day 目录下有 `src/` 源码与当日笔记 `.txt`
